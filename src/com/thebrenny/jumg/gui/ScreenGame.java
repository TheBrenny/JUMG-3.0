...
public class ScreenGame extends Screen {
	...
	public void moveCamera() {
		if(entityToFollow != null) {
			...
			setCameraX(Screen.getCameraX() + camMoveX);
			setCameraY(Screen.getCameraY() + camMoveY);
		}
	}
	...
	public int renderDebugEntity(Graphics2D g2d, int line) {
		...
		for(Entity e : level.getEntities()) {
			if(canCameraSeeEntity(e)) {
				...
				// draw name
				g2d2.drawString(e.getName(), (int) (eX - (mets.stringWidth(e.getName()) / 2) - cx), (int) (bb.getY() + Entity.ENTITY_SIZE + mets.getMaxAscent() - cy));
	...
	public int renderDebugTileEntity(Graphics2D g2d, int line) {
		...
		for(TileEntity te : level.getTileEntities()) {
			if(canCameraSeeTile(te.getTileX(), te.getTileY())) {
				...
				// draw bounding box
				g2d2.drawRect((int) (eX - cx), (int) (eY - cy), (int) Tile.TILE_SIZE, (int) Tile.TILE_SIZE);
				...
				// draw name
				g2d2.drawString(te.getName(), (int) (eX - (mets.stringWidth(te.getName()) / 2) - cx), (int) (eY + Entity.ENTITY_SIZE + mets.getMaxAscent() - cy));
